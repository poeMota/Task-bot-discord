...
Данный бот создан для организации работы отделов по принципу "тасков", бот сильно интегрирован со Space Station 14 и её сервисам, но может быть использован вне контекста данной игры благодаря гибкому конфигу.
...
- **Теги** - публикации тасков могут иметь теги разных видов, которые могут влиять на параметры таска:
